...
class KontrakanCard2 extends StatefulWidget {
  Kontrakan? kontrakan;
  var userID;
  KontrakanCard2({super.key,
      required this.kontrakan, this.userID});

  @override
  State<KontrakanCard2> createState() => _KontrakanCard2State();
}

class _KontrakanCard2State extends State<KontrakanCard2> {
    ...
    return GestureDetector(
      onTap: (() {
        ...
        Navigator.push(context,
          MaterialPageRoute(builder: (context) => Detailcarikontrakan(widget.kontrakan!, userID: widget.userID,)));
